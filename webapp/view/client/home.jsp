...
<body>
    <div class="container">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<%= request.getContextPath()%>/client/vol/prepareReservation?idVol=<%= vol.getIdVol() %>" class="button">Reserver</a>
                    </td>
                    <td>
                        <table>
                            <thead>
        ...
        <div style="text-align: center;">
            <a href="<%= request.getContextPath()%>/client/reservation/all" class="button">Liste Reservation</a>
        </div>
    </div>
</body>
</html>